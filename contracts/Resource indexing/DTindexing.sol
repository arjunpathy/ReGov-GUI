...
contract DTindexing {
    ...
    function registerPod(
        ...
        DTobligations obligation = new DTobligations(
            address(this),
            podAddress,
            monitoringOracle
        );
    ...
    function registerResource(
        ...
        resourceList.push(
            Resource(resourceCounter, msg.sender, newReference, podId, true)
        );
    ...
    event Address(address oracleAddress);
    struct Pod {
        int id;
        PodType podType;
        address owner;
